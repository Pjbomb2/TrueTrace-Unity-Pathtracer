...
namespace TrueTrace {
    ...
    {//This handels all the data
        ...
        public List<LightMapTriangle> LightMapTris;
        static public Camera SelectedCamera;
        ...
        [HideInInspector] public int DesiredRes;
        ...
        // void Start() {
        //     SelectedCamera.GetComponent<RayTracingMaster>().Start2();
        // }
