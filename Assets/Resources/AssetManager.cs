...
{//This handels all the data
    ...
    public VideoObject VideoPlayerObject;
    ...
    {//Creates texture atlas
        ...
        if (MetallicTexs.Count != 0) AddToAtlas(MetallicTexs, ref MetalAlphaRoughnessAtlas, out MetallicRects, AlbedoAtlas.width, 0, 0, MetallicTexChannelIndex);
        else { MetallicRects = new Rect[0]; }
        if (AlbedoTexs.Count != 0) AddToAtlas(AlbedoTexs, ref MetalAlphaRoughnessAtlas, out AlbedoRects, AlbedoAtlas.width, 3, 1, null);
        else { AlbedoRects = new Rect[0]; }
        if (RoughnessTexs.Count != 0) AddToAtlas(RoughnessTexs, ref MetalAlphaRoughnessAtlas, out RoughnessRects, AlbedoAtlas.width, 0, 2, RoughnessTexChannelIndex);
    ...
    private void init()
    {
        ...
        else
        {
            ...
            VideoPlayerObject = VideoAttatchedObject.GetComponent<VideoObject>();
