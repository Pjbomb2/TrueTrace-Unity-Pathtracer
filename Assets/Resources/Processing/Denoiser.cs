...
public class Denoiser {
    ...
    public Denoiser(Camera Cam) {
        _camera = Cam;
        if(SVGF == null) {SVGF = Resources.Load<ComputeShader>("Processing/SVGF");}
        if(AtrousDenoiser == null) {AtrousDenoiser = Resources.Load<ComputeShader>("Processing/Atrous");}
        if(Bloom == null) {Bloom = Resources.Load<ComputeShader>("Processing/Bloom");}
