...
public class RayTracingMaster : MonoBehaviour {
    ...
    [HideInInspector] public bool UseSVGF = true;
    ...
    void Start() {
        ...
        if(AtmosphereGeneratorShader == null) {AtmosphereGeneratorShader = Resources.Load<ComputeShader>("AtmosphereLUTGenerator");}
    ...
    private void Update() {
        SunDirection = new Vector3(Mathf.Cos(SunDirFloat), Mathf.Sin(SunDirFloat), 0.0001f);
    ...
    private void Render(RenderTexture destination) {
        ...
        if(!UseSVGF) {
            ...
            Denoisers.ExecuteSVGF(_currentSample, AtrousKernelSizes, ref _ColorBuffer, ref _PosTex, ref _target, ref _Albedo);
            CurrentSample = 1;
        }
