...
public string FolderPathName = "classroom";
    ...
    if(System.String.Equals(BSDF.MatType, "diffuse")) {
        if(BSDF.HasTexture) {
            ...
            BSDF.AlbedoTexture = Resources.Load<Texture2D>(Path);    
    ...
    } else if(System.String.Equals(BSDF.MatType, "roughconductor") || System.String.Equals(BSDF.MatType, "conductor")) {
        BSDF.MatIndex = 1;
                ...
                if(TargetObject.GetComponent<MeshFilter>() != null && TargetObject.GetComponent<MeshRenderer>() != null) {
                        ...
                        if(System.String.Equals(TargetObject.GetComponent<MeshRenderer>().sharedMaterial.name, "defaultMat")) {
                            ...
                            if(MeshLink.Contains(transform.GetChild(i).gameObject.name)) {
                                ...
                                NewMaterial.color = new Color(TargetBSDF.SurfaceColor.x, TargetBSDF.SurfaceColor.y, TargetBSDF.SurfaceColor.z, 1.0f);
                            }
